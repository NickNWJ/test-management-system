...
const SignUp = () => {
  ...
  const handleRegister = async (event) => {
    ...
    try {
      ...
      if (error.response.status === 409) {
        console.log(`409 Error -> ${error.response.data.message}`);
  ...
  return (
    <>
      ...
      {
        showSuccessDialog && <SuccessDialog message={"Sign Up Successfully!"}/>
      }
      {
        showErrorDialog && <ErrorDialog message={errorMessage}/>
      }
    </>
  );
};
